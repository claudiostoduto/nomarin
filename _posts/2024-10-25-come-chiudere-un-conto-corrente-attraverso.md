...
Bene, oltre a BBVA c’è questa opzione anche con isybank.  Parliamo della banca digitale del gruppo Intesa Sanpaolo che utilizzo prevalentemente per le spese quotidiane di tutti i giorni.

Per attivare questa opzione basta recarsi nella sezione altro e poi *Trasferisci in isybank*. Stessa dinamica di funzionamento con la possibilità di trasferire anche gli eventuali mandati e/o solamente il saldo e chiudere il conto.

Anche qui le tempistiche, che poi sono quelle previste dalla legge, sono le medesime.  Ergo un 13 giorni lavorativi dalla data di richiesta. In breve tempo noterete come verrà chiusa la posizione e, se presente, trasferito il saldo rimanente.

Quindi se volete chiudere un conto potete anche procedere tramite isybank, un’opzione in più oltre a quella offerta da BBVA.
