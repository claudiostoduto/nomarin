...
![Google-Photos-vs-iCloud.png](https://substack-post-media.s3.amazonaws.com/public/images/b21783b0-76bc-4dc7-98eb-19df7b11ca86_2000x983.png)**Inizialmente** ho dismesso Google Foto. Qui lo ammetto: per la privacy. Ok non so dove vadano a finire le foto su iCloud Photos di Apple, ma ammetto che mi sento un pelo più “sicuro” nell’avere le mie foto, di mio figlio e della mia compagna sui server di Cupertino. Poi, come ci ha insegnato Ed Snowden, tutto è possibile ma diciamo che se posso inizialmente metto una bella pezza e via.

![icloud-vs-google-drive.jpg](https://substack-post-media.s3.amazonaws.com/public/images/0bcb717b-a616-4cce-b312-577503386773_600x350.jpeg)Passo **numero 2** Google Drive. Ma come Claudio hai detto di no prima, calma ora vi spiego. Ero un grande utilizzatore di Drive per moltissime sue funzioni. Poi il prezzo era iper abbordabile e fra foto e documenti ci stavo abbondantemente dentro. Tuttavia, migrando le prime su iCloud per maggiore comodità e non dover fare manualmente il backup aprendo l’applicazione, ho dovuto migrare anche i file. Ammetto che Google non mi ha mai dato problemi, Apple invece una volta mi ha perso dei file, alcune volte li ha duplicati. Insomma la gestione non è ottimale come in casa BigG.

![JnBqtqrVVKKSBQk2CUAj4C.png](https://substack-post-media.s3.amazonaws.com/public/images/6162a9b0-fb7a-49bc-b888-64a8c6269b68_1920x1080.png)Il **terzo step** è stato Google Maps. Cancellato. Presa su App Store [Mapper](https://apps.apple.com/us/app/mapper-for-safari/id1589391989), una piccola estensione che praticamente converte in automatico tutti i link verso GMaps su Apple Maps. Ricordate tutti i problemi nel cercare alcuni POI che non erano e non sono ancora disponibili sul navigatore di Apple? Ecco problema risolto. Perché Apple Maps?

1. La grafica, decisamente migliore per tanti aspetti;

2. L’integrazione con l’ecosistema: cuffie, orologio ecc ecc;

3. Meno condivisione dei dati sulla mia posizione: io metto sempre il navigatore in auto anche quando so la strada, mi serve l’ETA;

4. Precisione, Google Maps nell’ultimo periodo era un po’ calato, sui miei tragitti abituali.

![duckduckgo-vs.-google_-an-in-depth-search-engine-comparison-60a7d7120fb7b.png](https://substack-post-media.s3.amazonaws.com/public/images/8da58610-9c54-46c6-b9a6-fa741fb4d2db_1600x840.png)**Quarto passaggio** il motore di ricerca. Un giorno, e qui veramente fu totalmente casuale, mi sono detto che forse potevo dare una seconda chance a DuckDuckGo. In un secondo lo misi su iPhone. Poi, anche qui senza rendermene conto, lo misi anche su macOS. Morale della favola, mi ritrovo ad aver modificato tutto sui vari dispositivi ed avercelo operativo. Problemi ad oggi? Zero. Risultati sempre trovati? Si.

![4b944ade-61cd-4533-9678-a41a25491728-1629906077513.png](https://substack-post-media.s3.amazonaws.com/public/images/9a105944-6e28-4aa6-ac73-8f6104f10550_2048x1334.png)Ultimo, ma non meno importante, il **passaggio numero 5** legato alla posta. Ve ne ho parlato in parte [qui](https://www.mrclaus.xyz/p/icloud-con-il-dominio-email-personalizzato). La gestione dei domini terzi sulla posta è nettamente facilitata in iCloud+. Certo si paga ma rientra nell’abbonamento mensile per foto, documenti mentre Gmail è gratis. Ci va un minimo di configurazione ma poi è facilitata come gestione. Inoltre ho la possibilità di nascondere il mio indirizzo email e, quindi, di avere molta meno spam. Sia chiaro che non ho chiuso Gmail e non penso che lo farò mai ad oggi.
